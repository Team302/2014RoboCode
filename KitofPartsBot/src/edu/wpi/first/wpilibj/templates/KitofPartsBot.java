...
public class KitofPartsBot extends IterativeRobot implements RobotMap {
    ...
    public void robotInit() {
        ...
        Shooter = new Shooter(Jaws, ShooterHolder, ShooterMotor, ShooterEncoder, CoOpstick, SHOOTER_OVERRIDE);
    ...
    public void autonomousPeriodic() {
        ...
        switch (AutonMode) {
            ...
            case BACKWARD_1: {
                if (LeftEncoder.getDistance() >= TargetDistanceL || RightEncoder.getDistance() >= TargetDistanceR) {
                    LeftCmd = -0.85 - (0.15 * DeltaDistance);
                    RightCmd = -0.85 + (0.15 * DeltaDistance);
                } else {
                    TimerCount = 0;
